...
% This implies the \(L^2\)-convergence is order 3.5 for quadratic elements on a uniform mesh (This rate is sometimes called superconvergence because it is one order higher than the \(H^1\) error order of 2).
