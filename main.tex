...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/convergence_smooth_M20.png}
...
\begin{table}[htbp]
	...
	\begin{tabular}{|c|c|S[table-format=1.2e-2]|c|S[table-format=1.2e-2]|c|S[table-format=1.2e-2]|c|}
		...
		\hline
		4   & 2.50e-01 & 9.03e-17 & --    & 1.39e-16 & --    & 3.19e-16 & --    \\
		\rowcolor{blue!5}
		...
		\hline
		\multicolumn{8}{|c|}{\cellcolor{blue!15}\textbf{Overall convergence rates (from polyfit):}} \\
		\multicolumn{8}{|c|}{$L^2: -2.03$ \qquad $L^\infty: -2.02$ \qquad $H^1: -2.03$} \\
		\hline
	\end{tabular}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{figures/convergence_complex_M15.png}
	\caption{Plots of FEM solution \(u_h(x)\) vs. exact solution \(u(x)\) (top),
		convergence plot (loglog scale with $L^2, L^\infty, H^1$ errors vs. mesh size $h$) (bottom left),
		and error plot (bottom right).}
...
\begin{table}[H]
	\centering
	\begin{tabular}{|>{\columncolor{blue!5}}c|c|S[table-format=1.2e-2]|c|S[table-format=1.2e-2]|c|S[table-format=1.2e-2]|c|}
	\hline
	...
	\hline
	\multicolumn{8}{|>{\columncolor{blue!15}}l|}{\textbf{Overall convergence rates (from polyfit):}} \\
	\multicolumn{8}{|>{\columncolor{blue!15}}l|}{L²: 3.33 \qquad L∞: 3.25 \qquad H¹: 2.04} \\
	\hline
	\end{tabular}
